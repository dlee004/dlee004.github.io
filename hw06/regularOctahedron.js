...
export class RegularOctahedron {
    constructor(gl, options = {}) {
        ...
        this.vertices = new Float32Array([
            // triangle 1 (v0, v1, v4)
            -0.5, 0.0, 0.5, 0.5, 0.0, 0.5, 0.0, 0.8660254, 0.0,
            // triangle 2 (v1,v2, v4)
            0.5, 0.0, 0.5, 0.5, 0.0, -0.5, 0.0, 0.8660254, 0.0,
            // triangle 3 (v2,v3, v4)
            0.5, 0.0, -0.5, -0.5, 0.0, -0.5, 0.0, 0.8660254, 0.0,
        ...
        this.normals = new Float32Array([
            // triangle 1 (v0,v1,v4)
            0.0, 0.5, 0.8660254, 0.0, 0.5, 0.8660254, 0.0, 0.5, 0.8660254,
            // triangle 2 (v1,v2,v4)
            0.8660254, 0.5, 0.0, 0.8660254, 0.5, 0.0, 0.8660254, 0.5, 0.0,
            // triangle 3 (v2,v3,v4)
            0.0, 0.5, -0.8660254, 0.0, 0.5, -0.8660254, 0.0, 0.5, -0.8660254,
            // triangle 4 (v3,v0,v4)
            -0.8660254, 0.5, 0.0, -0.8660254, 0.5, 0.0, -0.8660254, 0.5, 0.0,
        ...
        if (options.color) {
            ...
            this.colors = new Float32Array([
                ...
                // triangle 5 (v0,v1,v5) - red
                1, 0, 0, 0.5, 1, 0, 0, 0.5, 1, 0, 0, 0.5,
                // triangle 6 (v1,v2,v5) - yellow
                1, 1, 0, 0.5, 1, 1, 0, 0.5, 1, 1, 0, 0.5,
                // triangle 7 (v2,v3,v5) - magenta
                1, 0, 1, 0.5, 1, 0, 1, 0.5, 1, 0, 1, 0.5,
                // triangle 8 (v3,v0,v5) - cyan
                0, 1, 1, 0.5, 0, 1, 1, 0.5, 0, 1, 1, 0.5,
            ]);
        }
